...
% \underline{\textbf{Short-Run and Long-Run Costs}}

% \textbf{Short-Run Costs} are when at least one input is fixed (e.g. a business cannot immediately change its factory size).

% \textbf{Long-Run Costs} are when all inputs are variable; the business can fully restructure its cost base at any time.

% \underline{\textbf{Intangible and Tangible Costs}}

% \subsubsection{Defining Value}\mbox{}
% \subsubsection{Benefits vs Sacrifice}\mbox{}
% \subsubsection{Functional vs Emotional Value}\mbox{}
% \subsubsection{Value Models}\mbox{}
% BI - Value Propositions
% \subsection{Defining Value Proposition}
% \subsubsection{Types of Value Proposition}\mbox{}